...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_by_page', action='store_true', default=True)
    parser.add_argument('--time', type=int, default=2, help='waiting time for driver.get(url) by seconds')
